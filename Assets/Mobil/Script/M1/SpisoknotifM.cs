...
public class SpisoknotifM : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //string userId = "0"; 
        StartCoroutine (GetPlataIDs(userId ,PlayerPrefs.GetString("street"),PlayerPrefs.GetString("house"),_createItemsCallback));
    ...
    IEnumerator CreateItemsRoutine(string jsonArrayString){
        ...
        for(int i = 0; i < jsonArray.Count ; i++){
            ...
            GameObject item = Instantiate (Resources.Load("Prefabs/itemNotifm") as GameObject);
    ...
    public IEnumerator GetPlataIDs(string userID,string street,string house,System.Action<string> callbackU){//I_krug.SetActive(true);
        WWWForm form = new WWWForm();
        form.AddField("userID", userID);
        form.AddField("street", street);form.AddField("house", house);
        using (UnityWebRequest www = UnityWebRequest.Post("https://playklin.000webhostapp.com/yk/GetIDsALLyknotifbyadres.php",form)){
    ...
    public IEnumerator GetPlata(string itemID, System.Action<string> callbackU){
        ...
        using (UnityWebRequest www = UnityWebRequest.Post("https://playklin.000webhostapp.com/yk/GetInfoIDyknotifbymob.php", form)){
        yield return www.SendWebRequest();
