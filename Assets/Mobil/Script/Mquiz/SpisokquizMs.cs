...
public class SpisokquizMs : MonoBehaviour {
   ...
   #region HASH KOD ----
    ...
    public IEnumerator GetJson(string face,System.Action<TestItemModel[]> callback){
        ...
        using (UnityWebRequest www = UnityWebRequest.Post("https://playklin.000webhostapp.com/yk/GetALLykquiz.php",form)){
    ...
    void InitializeItemView (GameObject viewGameObject, TestItemModel model)
    {
        ...
        view.clickButton.onClick.AddListener(
            ()=> 
            {
                ...
                PlayerPrefs.SetString("id_quiz", view.id.text);
