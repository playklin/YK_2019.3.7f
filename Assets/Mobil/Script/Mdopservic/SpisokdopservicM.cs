...
public class SpisokdopservicM : MonoBehaviour
{
    ...
    IEnumerator CreateItemsRoutine(string jsonArrayString){
        ...
        for(int i = 0; i < jsonArray.Count ; i++){
            ...
            GameObject item = Instantiate (Resources.Load("Prefabs/itemDSm") as GameObject);
    ...
    public IEnumerator GetPlataIDs(string userID,System.Action<string> callbackU){//I_krug.SetActive(true);
        ...
        using (UnityWebRequest www = UnityWebRequest.Post("https://playklin.000webhostapp.com/yk/GetIDsALLykds.php",form)){
    ...
    public IEnumerator GetPlata(string itemID, System.Action<string> callbackU){
        ...
        using (UnityWebRequest www = UnityWebRequest.Post("https://playklin.000webhostapp.com/yk/GetInfoIDykds.php", form)){
        yield return www.SendWebRequest();
