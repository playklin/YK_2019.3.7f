...
public class SpisokWeb5Ws : MonoBehaviour {
   ...
   #region 
    ...
    public IEnumerator GetJson(string face,System.Action<TestItemModel[]> callback){
        ...
        using (UnityWebRequest www = UnityWebRequest.Post("https://playklin.000webhostapp.com/yk/Order/GetALLOPENykorder.php",form)){
