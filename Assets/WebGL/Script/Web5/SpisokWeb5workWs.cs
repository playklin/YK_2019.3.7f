...
public class SpisokWeb5workWs : MonoBehaviour {
   ...
   #region 
    ...
    public IEnumerator GetJson(string face,System.Action<TestItemModel[]> callback){
        ...
        using (UnityWebRequest www = UnityWebRequest.Post("https://playklin.000webhostapp.com/yk/Order/GetALLWORKykorder.php",form)){
