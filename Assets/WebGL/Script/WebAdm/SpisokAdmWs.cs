...
public class SpisokAdmWs : MonoBehaviour {

    public RectTransform prefarb;
    public RectTransform content;
    public static string id_yk_adm = "10";
   ...
   #region HASH KOD ----
    ...
    public IEnumerator GetJson(string face,System.Action<TestItemModel[]> callback){
        ...
        using (UnityWebRequest www = UnityWebRequest.Post("https://playklin.000webhostapp.com/yk/GetALLykAdm.php",form)){
