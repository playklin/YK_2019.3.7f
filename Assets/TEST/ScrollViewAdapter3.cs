...
public class ScrollViewAdapter3 : MonoBehaviour
{
    ...
    public void UpdateItems (){
        ...
        StartCoroutine(GetItems(modelsCount, results => OnReceiveModels(results)));
    }

    void OnReceiveModels (TestItemModel[] models){
